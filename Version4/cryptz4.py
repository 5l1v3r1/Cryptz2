...
#####
def banner():
    print(unknown2 + "\n  https://github.com/inc0gnit0/cryptz\n")
    print(unknown15 + "   ####   #####   #   #  #####   #####  ###### ")
    print(unknown15 + "  #    #  #    #   # #   #    #    #        # ")
    print(unknown15 + "  #       #    #    #    #    #    #       # ")
    print(unknown15 + "  #       #####     #    #####     #      # ")
    ...
    print(unknown15 + "  Twitter && Instagram: " + Red +"TW-DH2ck(Do0pH2ck) i.nc0gnit0(inc0gnit0)\n" + Reset)
...
#     #decrypted_text = b64decode(decrypted_text)
        ...
        for i in range(1):
            ...
            if result:
                for i in result:
                    ...
                    def menu():
                        #strings = "1h3sgj5ks3erhg3h5dh23455wer32cfewjkf"
                        print(unknown7 + '  1. Encrypt\n')
                        print(unknown3 + '  2. Decrypt\n')
                        print(unknown2 + '  3. Exit\n')
